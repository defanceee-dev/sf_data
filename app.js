...
function bindEls() {
  ...
  els.cartCount = document.getElementById("floatingCartCount");
  els.floatingCartTotal = document.getElementById("floatingCartTotal");
...
function updateCartUI() {
  ...
  els.floatingCartTotal.textContent = `${totalPrice} грн`;
